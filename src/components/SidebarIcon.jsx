...
export function SidebarIcon({name, size=18, strokeWidth=1.9}) {
  ...
  const paths = {
    ...
    inspeksi: <><rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4V2h6v2M9 12l2 2 4-4"/></>,
    inspeksiMaterial: <><rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4V2h6v2M9 12l2 2 4-4"/></>,
