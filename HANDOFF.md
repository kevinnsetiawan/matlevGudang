...
- 2026-07-15 18:11 Claude: paket TUG-10 (cascade lokasi, satpam per gudang, checklist Ajukan, kartu material) + pagination Forecast di-commit; lanjut fix akar "Ajukan diam": `_isDataUrl` tak diimpor + 5 import/prop hilang lain, overlay "Menyimpan Transaksi", catch & timeout upload — commit + push ke `main`.
