...
- **Langkah berikutnya:** user uji Pak War online di `http://localhost:3001` — format jawaban baru (humanis-korporat, jawab yang ditanya saja tanpa analisis/rekomendasi, list material jadi kartu `.ai-richlist` + selalu sebut lokasi, jawaban AI satu bubble). Jika oke, commit+push (deploy) lalu lanjut migrasi Non-SAP review-first. Format 📊/🔍/💡 sengaja dipertahankan di drill-down Forecast Stok.
